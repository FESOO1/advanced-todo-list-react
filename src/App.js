    ...
    return (
        <form className='main-input'>
            ...
            <button className='main-input-button' type='submit' onClick={onSubmitTodo}>
                ...
                <svg className='main-input-button-svg-second' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
                    <path d="M12 4V20M20 12H4" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            </button>
        </form>
    );
...
function TodoListOutputEmpty() {
    return (
        <div className='main-output-empty'>
            ...
            <svg className='main-output-empty-svg-second' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
                <ellipse cx="12" cy="5" rx="8" ry="3" stroke="black" strokeWidth="1.5"></ellipse>
                <path d="M20 12C20 13.6569 16.4183 15 12 15C7.58172 15 4 13.6569 4 12" stroke="black" strokeWidth="1.5"></path>
                <path d="M20 5V19C20 20.6569 16.4183 22 12 22C7.58172 22 4 20.6569 4 19V5" stroke="black" strokeWidth="1.5"></path>
                <path d="M8 8V10" stroke="black" strokeWidth="1.5" strokeLinecap="round"></path>
                <path d="M8 15V17" stroke="black" strokeWidth="1.5" strokeLinecap="round"></path>
            </svg>
        </div>
    );
};
    ...
    return (
        <div className={classes}>
            ...
            <button type='button' className='main-output-delete-button' onClick={() => onClickDelete(todo.id)}>
                ...
                <svg className='main-output-delete-button-svg-second' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
                    <path d="M19.5 5.5L18.8803 15.5251C18.7219 18.0864 18.6428 19.3671 18.0008 20.2879C17.6833 20.7431 17.2747 21.1273 16.8007 21.416C15.8421 22 14.559 22 11.9927 22C9.42312 22 8.1383 22 7.17905 21.4149C6.7048 21.1257 6.296 20.7408 5.97868 20.2848C5.33688 19.3626 5.25945 18.0801 5.10461 15.5152L4.5 5.5" stroke="black" strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M3 5.5H21M16.0557 5.5L15.3731 4.09173C14.9196 3.15626 14.6928 2.68852 14.3017 2.39681C14.215 2.3321 14.1231 2.27454 14.027 2.2247C13.5939 2 13.0741 2 12.0345 2C10.9688 2 10.436 2 9.99568 2.23412C9.8981 2.28601 9.80498 2.3459 9.71729 2.41317C9.32164 2.7167 9.10063 3.20155 8.65861 4.17126L8.05292 5.5" stroke="black" strokeWidth="1.5" strokeLinecap="round"></path>
                    <path d="M9.5 16.5L9.5 10.5" stroke="black" strokeWidth="1.5" strokeLinecap="round"></path>
