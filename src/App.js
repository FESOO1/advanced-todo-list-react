...
function TodoListInput() {
    return (
        <form className='main-input'>
            <input type='text' placeholder='Add a todo fing list...' className='main-input-itself' />
...
function TodoListFilter() {
    const filterButtons = [{ text: 'ALL', isActive: true }, { text: 'IN PROGRESS', isActive: false }, { text: 'DONE', isActive: false }];
    ...
    return (
        <div className='main-filter'>
            {filterButtons.map(filterButton => {
                ...
                return (
                    <button key={text} className={classes} type='button'>{text}</button>
                );
            })}
        </div>
    );
                ...
                return (
                    <div key={todo.id} className={classes}>
                        <div className='main-output-checkbox'>
                            <input type='checkbox' className='main-output-checkbox-input' /* checked={isDone} */ />
                        </div>
                        <button className='main-output-edit-button' type='button'>
                            ...
                            {/* <h6 className='main-output-edit-button-id'>ADDED: {todo.date}</h6> */}
                        </button>
